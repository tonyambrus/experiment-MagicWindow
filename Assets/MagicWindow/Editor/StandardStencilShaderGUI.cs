...
{
    internal class StandardStencilShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent stencilText = EditorGUIUtility.TrTextContent("Stencil Value", "Stencil Value");
        ...
        {
            stencilMask = FindProperty("_StencilMask", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            {
                m_MaterialEditor.ShaderProperty(stencilMask, Styles.stencilText);
